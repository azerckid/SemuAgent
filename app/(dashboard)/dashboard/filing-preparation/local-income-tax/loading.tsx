export default function LocalIncomeTaxLoading() {
  return (
    <div className="flex min-h-full flex-col bg-company-bg">
      <div className="border-b border-company-border bg-company-surface px-7 py-3.5">
        <div className="h-3 w-44 rounded-full bg-company-border" />
      ...
      <div className="flex w-full max-w-[1240px] flex-col gap-[22px] px-7 pt-6 pb-12">
        ...
        <div className="h-[260px] rounded-xl border border-company-border bg-company-surface" />
        <div className="h-[72px] rounded-xl border border-company-border bg-company-surface" />
      </div>
    </div>
  )
}
