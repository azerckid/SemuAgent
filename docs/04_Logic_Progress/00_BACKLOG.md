...
- Status: in_progress (T0 문서 승인 · T1 runtime 진행)
...
- Document Sync Check: 2026-07-18 (T1 runtime) - next-themes AppThemeProvider(default system, storageKey semuagent-theme), Sidebar ThemeModeMenu(시스템 설정/라이트/다크·menuitemradio), company-* dark tokens + color-scheme, shell literal→token. 세비서 고정 charcoal은 T2 유지.
