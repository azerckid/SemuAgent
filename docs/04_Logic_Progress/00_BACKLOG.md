...
- Implementation Preconditions (조사·설계 과제):
  ...
  - [ ] **근로소득 지급명세서 Stage F Runtime~Closeout** — 승인 Preview 구조로 실제 DB를 연결하고 tenant·사업장·연도 격리, 합계/상태, 진행 중 연도, PII 비수집을 단위·정적·브라우저에서 검증한 뒤 문서를 닫는다
