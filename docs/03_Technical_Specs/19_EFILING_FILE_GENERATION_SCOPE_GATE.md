...
특별징수는 위택스 공식 Excel 파일신고가 확인되어 1b가 아닌 Path 1a 후보이며,
[Stage A Audit](./54_JC030_LOCAL_INCOME_TAX_UPLOAD_TEMPLATE_ACQUISITION.md)에 따라 공식
원본 입수·구조 고정부터 진행한다. 순서·게이트는
