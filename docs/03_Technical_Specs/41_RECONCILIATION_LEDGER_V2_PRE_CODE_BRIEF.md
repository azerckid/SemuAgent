...
| 2b-2c-2 | 2b | Evidence exception | G: evidence exception; P: confirm evidence exception | User can mark a bank row as a normal-evidence exception such as internal transfer, loan, tax payment, refund/cancellation, or similar. This needs explicit exception type/memo storage before implementation. |
...
- [ ] Slice 2b-2c-2 evidence exception — explicit exception type/memo storage required before code.
