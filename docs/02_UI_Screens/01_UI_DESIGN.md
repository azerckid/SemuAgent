...
| VAT Savings Opportunities | 접대비 불공제 후보 중 복리후생비·회의비로 재분류할 가능성이 있는 거래 | 세액 요약 바로 아래 별도 목록. 기본 행은 거래·재분류 방향·최대 추가 공제 가능성만, 신뢰도·근거·부족 자료는 펼쳐보기. 후보 0건이면 미표시. VAI-9d Preview 승인 대기 |
