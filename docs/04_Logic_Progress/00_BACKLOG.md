...
- Status: `in_progress` (CUI-3 완료 · CUI-4 Preview 승인 PR #271 · **CUI-4 Brief 승인 PR #272** · 다음 CUI-4a runtime)
...
- Implementation Preconditions:
  ...
  - [ ] CUI-4a runtime: period 역산·표시 헬퍼 + 결과 카드 + §4.3 import 표 세션 필터
- Acceptance Criteria:
