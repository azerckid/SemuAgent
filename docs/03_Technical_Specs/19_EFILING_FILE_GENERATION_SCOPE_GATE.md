...
| 근로소득 지급명세서 | JC-024 연간 지급·기납부 원천세 준비 + Stage B 현행 제24호서식 매핑 | Stage C에서 홈택스 생성 결과를 최종 정본으로 확정; SemuAgent는 급여 기초자료 준비 | **Path 1b 대상 · Stage D Preview 다음** |
...
준비한다고 결정했다. 다음은 Stage D의 간결한 HTML Preview와 오너 승인이다.
