...
- Status: `in_progress` (CUI-3 구현·전용 Preview QA 완료·PR #270 검토 대기 · CUI-4 최근 업로드 결과 카드 HTML Preview 제작·오너 확인 대기)
...
- Implementation Preconditions:
  ...
  - [ ] CUI-4 HTML Preview: 최근 업로드 세션 결과 카드 1개·DB 정본 건수·`period + sessionId` 필터 CTA 오너 승인
- Acceptance Criteria:
