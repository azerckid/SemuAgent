...
- Implementation Preconditions:
  ...
  - [ ] 자료대조원장 Slice 2a-1 read model 착수 — Brief §2.1 step 2a-1 (Zod, 기간, action-state, 매칭, blocker, nextActions, taxBlockerSummaries, closingChecklist)
