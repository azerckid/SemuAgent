...
- Implementation Preconditions (조사·설계 과제):
  ...
  - [ ] **근로소득 지급명세서 Stage E Pre-Code** — 승인 Preview 기준 Screen Flow·UI Design·Pre-Code Brief와 read model·상태 계약을 동기화한다. 완료 전 runtime·schema·API 금지
