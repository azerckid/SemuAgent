...
import { listAccumulatedClassificationRows } from '@/lib/bookkeeping/fiscal-year-ledger-classification-view'
...
export async function GET(
  ...
  try {
    ...
    const result = await listAccumulatedClassificationRows({
      tenantId,
      ledgerId,
    ...
    console.error('[GET /api/bookkeeping-ledgers/[ledgerId]/account-classification]', err)
