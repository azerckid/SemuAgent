...
아래 시나리오는 [VAT AI Evidence-Backed Decisive Judgment Brief](../03_Technical_Specs/50_VAT_AI_EVIDENCE_BACKED_DECISIVE_JUDGMENT_BRIEF.md)를 기준으로 한다. VAI-8a에서 잠정 결론과 workflow를 분리했으며, evidence trace·근거 없음 기본처리·담당자 이관은 VAI-8b~8e에서 이어간다.
