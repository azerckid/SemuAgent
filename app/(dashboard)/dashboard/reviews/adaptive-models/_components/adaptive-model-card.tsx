...
import { reviewAdaptiveModelContractSchema } from '@/lib/reviews/adaptive-structuring-model-contract'
import type { ReviewAdaptivePreviewRow } from '@/lib/reviews/adaptive-structuring-common-engine'
...
export function AdaptiveModelCard({
  ...
  const parsedContract = reviewAdaptiveModelContractSchema.safeParse(safeParseJson(model.modelJson))
  const sampleRows = safeParseJson<ReviewAdaptivePreviewRow[]>(model.sampleRowsPreviewJson) ?? []
