...
import { approveReviewAdaptiveModel } from '@/lib/reviews/adaptive-structuring-registry'
...
export async function POST(
  ...
  try {
    ...
    const result = await approveReviewAdaptiveModel({ tenantId, modelId, approvedByStaffId: staffId })
    if (!result.success) {
    ...
    console.error('[POST /api/review/adaptive-models/[id]/approve]', err)
