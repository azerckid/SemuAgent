...
- Document Sync Check: 2026-07-05 영향 감사 + Slice 1~2c + Slice 3a~3b + Slice 3c-0 + **Slice 3c-1(2026-07-06, company-home read switch, PR #103)** 완료. 다음: **Slice 3c-2** source collection validation additive FK(migration 0062). prod migration은 머지 전 schema 확인 필수.
