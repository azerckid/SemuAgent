...
| JC-043 | in_progress | 대화형 세무 작업공간 — 첫 화면·오케스트레이션 | 기존 회사 홈·자료수집·워크스페이스·AI orchestration | **CUI-4 파일 카드 유지. CUI-4d Brief/QA draft(65·15) 오너 검토 대기 — runtime 금지. 다음: S2 Preview Gate → Brief 승인 → CUI-4d runtime → CUI-5.** [Execution Plan](./01_EXECUTION_PLAN.md) · [Operating Model](../01_Concept_Design/05_SEBISEO_OPERATING_MODEL.md) · [Brief 63](../03_Technical_Specs/63_JC043_CUI4_SEBISEO_UPLOAD_RESULT_CARD_PRE_CODE_BRIEF.md) · [Brief 65 CUI-4d](../03_Technical_Specs/65_JC043_CUI4D_NEEDS_REVIEW_TXN_LEDGER_PRE_CODE_BRIEF.md) · [QA 13](../05_QA_Validation/13_JC043_CUI4_SEBISEO_UPLOAD_RESULT_CARD_TEST_SCENARIOS.md) · [QA 15](../05_QA_Validation/15_JC043_CUI4D_NEEDS_REVIEW_TXN_LEDGER_TEST_SCENARIOS.md) · [Preview 19](../02_UI_Screens/previews/19_sebiseo.html) |
...
- Related Technical Docs: [62 CUI-3 Pre-Code Brief](../03_Technical_Specs/62_JC043_CUI3_SEBISEO_UPLOAD_CHAT_PRE_CODE_BRIEF.md) - 자료수집 API 재사용·대화 범위·실패 상태·tenant·가드레일·Component/Library Plan. [63 CUI-4 Pre-Code Brief](../03_Technical_Specs/63_JC043_CUI4_SEBISEO_UPLOAD_RESULT_CARD_PRE_CODE_BRIEF.md) - 파일 단위 결과 카드. [65 CUI-4d Pre-Code Brief](../03_Technical_Specs/65_JC043_CUI4D_NEEDS_REVIEW_TXN_LEDGER_PRE_CODE_BRIEF.md) - 확인 필요 거래 → 자료대조원장(draft).
- Related QA Docs: [12 CUI-3 Test Scenarios](../05_QA_Validation/12_JC043_CUI3_SEBISEO_TEST_SCENARIOS.md) - trust 회귀·업로드·대화·라우팅·격리. [13 CUI-4](../05_QA_Validation/13_JC043_CUI4_SEBISEO_UPLOAD_RESULT_CARD_TEST_SCENARIOS.md) · [15 CUI-4d](../05_QA_Validation/15_JC043_CUI4D_NEEDS_REVIEW_TXN_LEDGER_TEST_SCENARIOS.md) (draft).
...
- Document Sync Check (2026-07-19, CUI-4d Brief draft): [Brief 65](../03_Technical_Specs/65_JC043_CUI4D_NEEDS_REVIEW_TXN_LEDGER_PRE_CODE_BRIEF.md)·[QA 15](../05_QA_Validation/15_JC043_CUI4D_NEEDS_REVIEW_TXN_LEDGER_TEST_SCENARIOS.md) 초안 — 거래 단위 확인 필요 read model, 파일/거래 집계 분리, `reconciliation-ledger?period&sessionId&source=needs_decision` CTA, 1:1 행 대응, mutation 금지. S2 HTML Preview Gate와 Brief·QA 오너 승인 전 runtime 착수하지 않는다.
